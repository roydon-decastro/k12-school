                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        ...
                        <div class="">
                            ...
                            <select class="w-full bg-white  border border-gray-200 rounded-lg "
                                wire:model="selectedGradeLevel" wire:change="filterByGradeLevel">
                        ...
                        @if ($level_subjects !== null)
                            ...
                            <div class="">
                                <label for="selectedSubject"
                                    class="block mr-4 mt-3 mb-1 text-lg font-bold dark:text-white border-slate-300">Subject</label>
                                <select class="w-full bg-white  border border-gray-200 rounded-lg "
                                    wire:model="selectedSubject" required>
                            ...
                            <table class="border-collapse border border-slate-400 p-4">
                                ...
                                <tbody class="mb-4">
                                    @foreach ($section_students as $index => $section_student)
                                        <tr>
                                            <td wire:model='attendance.{{ $index }}.id'
                                                class="border border-slate-300 p-4">
                                                {{ ucwords($section_student->studentName) }}</td>
                                            <td class="border border-slate-300 p-4 "><input
                                                    wire:model='attendance.{{ $index }}.present' class=" "
