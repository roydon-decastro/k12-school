        ...
        <form wire:submit.prevent="UpdateStudentGrades" class="w-full">
            <div class="mb-6">
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                    ...
                    <div class="">
                        <label for="selectedStudent"
                            class="block mr-4 mt-3 mb-1 text-lg font-bold dark:text-white border-slate-300">Student</label>
                        <select class="w-full bg-white  border border-gray-200 rounded-lg " wire:model="selectedStudent"
                            wire:change="filterByStudent">
            ...
            @if (!empty($grade_students))
                <div>
                    ...
                    @foreach ($grade_students as $index => $grade_student)
                        <div wire:model="grade_students"
                            class="overflow-y-auto mb-6 bg-white border border-amber-200 rounded-lg p-4 ">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex">
                                    @if ($grade_student->q1 != null)
                                        ...
                                        <div
                                            class="p-6 bg-white  rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 columns-1 mr-6">
                                            <p class="text-xl font-medium">1st Quarter</p>
                                            @foreach ($q1_grade_subjects as $subject => $grade)
                                                <div
                                                    class="p-6 bg-white  rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 columns-1 mr-6 mt-4">
                                                    <p class=" font-bold text-base">{{ $subject }}</p>
                                                    <div class="flex mr-6">
                                                        <div>
                                                            <label for="current"
                                                                class="block mt-3 mb-1 text-sm font-normal dark:text-white">Current</label>
                                                            <input name="current"
                                                                class="w-20 bg-white  border border-gray-200 rounded-lg mr-2 "
                                                                type="number" max="100"
                                                                value="{{ $grade }}" disabled>
                                                        </div>
                                                        <div>
                                                            <label for="q1_edit.{{ $subject }}"
                                                                class="block mt-3 mb-1 text-sm font-normal dark:text-white">New</label>
                                                            <input wire:model='q1_edit.{{ $subject }}'
                                                                name="q1_edit.{{ $subject }}"
                                                                class="w-20 bg-white  border border-gray-200 rounded-lg"
                                                                type="number" max="100">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            @foreach ($q2_grade_subjects as $subject => $grade)
                                                <div
                                                    ...
                                                    <div class="flex mr-6">
                                                        ...
                                                        <div>
                                                            <label for="q2_edit.{{ $subject }}"
                                                                class="block mt-3 mb-1 text-sm font-normal dark:text-white">New</label>
                                                            <input wire:model='q2_edit.{{ $subject }}'
                                                                name="q2_edit.{{ $subject }}"
                                                                class="w-20 bg-white  border border-gray-200 rounded-lg"
                                                                type="number" max="100">
                                                        </div>
                                                    </div>
                                            ...
                                            @foreach ($q3_grade_subjects as $subject => $grade)
                                                <div
                                                    ...
                                                    <div class="flex mr-6">
                                                        ...
                                                        <div>
                                                            <label for="q3_edit.{{ $subject }}"
                                                                class="block mt-3 mb-1 text-sm font-normal dark:text-white">New</label>
                                                            <input wire:model='q3_edit.{{ $subject }}'
                                                                name="q3_edit.{{ $subject }}"
                                                                class="w-20 bg-white  border border-gray-200 rounded-lg"
                                                                type="number" max="100">
                                                        </div>
                                                    </div>
                                            ...
                                            @foreach ($q4_grade_subjects as $subject => $grade)
                                                <div
                                                    ...
                                                    <div class="flex mr-6">
                                                        ...
                                                        <div>
                                                            <label for="q4_edit.{{ $subject }}"
                                                                class="block mt-3 mb-1 text-sm font-normal dark:text-white">New</label>
                                                            <input wire:model='q4_edit.{{ $subject }}'
                                                                name="q4_edit.{{ $subject }}"
                                                                class="w-20 bg-white  border border-gray-200 rounded-lg"
                                                                type="number" max="100">
                                                        </div>
                                                    </div>
                            ...
                            <div class="block mt-4">
                                <label for="grade_student_id"
                                    class="block mt-3 mb-1 text-sm font-normal dark:text-white">Record ID</label>
                                <select class="w-36 bg-white  border border-gray-200 rounded-lg "
                                    wire:model="grade_student_id" required>
                        ...
                        <div class="mt-4">
                            ...
                            <button type="submit"
                                class="px-6 py-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Update
                                Grades</button>
                        </div>
                        <div>
                            <p class="text-sm mt-2 italic">This transaction will be recorded using
                                {{ Auth::user()->name }}'s details.</p>
                        </div>
                </div>
    </div>
    @endforeach
